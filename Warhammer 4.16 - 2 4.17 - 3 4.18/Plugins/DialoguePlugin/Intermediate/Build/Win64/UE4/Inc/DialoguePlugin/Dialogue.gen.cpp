...
static struct FScriptStruct_DialoguePlugin_StaticRegisterNativesFDialogueEvents
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FDialogueEvents()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_WorldConditions = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("WorldConditions"), RF_Public|RF_Transient|RF_MarkAsNative) UMapProperty(CPP_PROPERTY_BASE(WorldConditions, FDialogueEvents), 0x0010000000000005);
			UProperty* NewProp_WorldConditions_Key_KeyProp = new(EC_InternalUseOnlyConstructor, NewProp_WorldConditions, TEXT("WorldConditions_Key"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000001);
			UProperty* NewProp_WorldConditions_ValueProp = new(EC_InternalUseOnlyConstructor, NewProp_WorldConditions, TEXT("WorldConditions"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, 1, 0x0000000000000001, 0, sizeof(bool), true);
			...
			MetaData->SetValue(NewProp_WorldConditions, TEXT("Category"), TEXT("Global Variables"));
			MetaData->SetValue(NewProp_WorldConditions, TEXT("ModuleRelativePath"), TEXT("Classes/Dialogue.h"));
			MetaData->SetValue(NewProp_WorldConditions, TEXT("ToolTip"), TEXT("TMap of all world conditions that will cause events. Here is the dialogue version which will set the corresponding TMap in the WarhammerGameModeBase"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FDialogueEvents_CRC() { return 2025674470U; }
