 ...
 */
class IDialoguePluginEditorModule : public IModuleInterface
{
...
public:
	 ...
	 */
	static inline IDialoguePluginEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked< IDialoguePluginEditorModule >( "DialoguePluginEditor" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "DialoguePluginEditor" );
	}
